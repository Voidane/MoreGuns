...
namespace MoreGunsMono.Gui
{
    public static class WindupIndicator
    {
        ...
        {
            AssetBundleRequest rqWindupIndicator = MoreGunsMod.assetBundle.LoadAssetAsync<GameObject>($"assets/ui/Windup Indicator.prefab");
            yield return rqWindupIndicator;
            GameObject _windupIndicator = rqWindupIndicator.asset as GameObject;
            windupIndicator = UnityEngine.GameObject.Instantiate(_windupIndicator, parent);
